...
const sl: typeof en = {
  ...
  stepsChallenge: {
    devTitle: 'Hoja korakov (dev)',
    introTitle: 'Na noge',
    introBody:
      'Alarm bo zvonil, dokler ne narediš dovolj korakov. Vzemi telefon in se premikaj — štetje se začne ob pritisku Začni.',
    goalLabel: 'Tvoj cilj',
    goalUnit: 'korakov',
    startWalking: 'Začni hoditi',
    cheerStart: 'Na noge — vsak korak šteje.',
    cheerMoving: 'Super — kar tako naprej.',
    cheerHalf: 'Polovica. Zmoreš.',
    cheerAlmost: 'Skoraj tam — še nekaj korakov!',
    cheerDone: 'Cilj dosežen!',
    remaining: (n: number) => `Še ${n} korakov`,
    goalReached: 'Cilj dosežen!',
    activeHint: 'Hodi po sobi ali hodniku. Alarm se ustavi, ko dosežeš cilj.',
  ...
  streak: {
    ...
    challengeBreakdown: 'Pregled izzivov',
    challengeBreakdownHint: 'Uspešno opravljeni izzivi',
    challengeTime: 'Čas izziva',
    avgChallengeTime: 'Povprečje',
    fastestChallenge: 'Najhitreje',
    slowestChallenge: 'Najpočasneje',
    insightsEmpty: 'Opravi izziv, da vidiš statistiko',
    earlyBirdTitle: 'Early bird rezultat',
    earlyBirdHint: (hour: number) => `Jutra, ko si končal pred ${hour}:00`,
    earlyBirdDetail: (early: number, total: number, hour: number) =>
      `${early} od ${total} dni pred ${hour}:00`,
    earlyBirdTier: {
      nightOwl: 'Nočna ptica',
      rising: 'Vstajaš zgodaj',
      earlyBird: 'Early bird',
      sunriseChampion: 'Prvak sončnih vzhodov',
    },
    durationSec: (n: number) => `${n} s`,
    durationMinSec: (m: number, s: number) => (s > 0 ? `${m} min ${s} s` : `${m} min`),
  ...
  settings: {
    ...
    voicePhraseModalSubtitle: 'Tvoja fraza za budjenje. Izberi predlog ali vpiši svojega.',
    voicePhraseInputPlaceholder: 'Vpiši svojo frazo za budjenje…',
    voicePhraseSuggestions: 'Predlogi',
    voicePhraseEmpty: 'Fraza ni nastavljena',
    stepGoal: 'Cilj korakov',
    stepGoalModalTitle: 'Cilj korakov',
    stepGoalModalSubtitle: 'Koliko korakov za izklop alarma. Med 30 in 200.',
    stepGoalInputPlaceholder: 'npr. 50',
    stepGoalRangeError: 'Vnesi število med 30 in 200.',
